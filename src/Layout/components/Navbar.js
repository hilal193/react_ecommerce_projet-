        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            <div className="home">
              ...
              {/* <ul>
                <li><a className="dropLink" href="#">Homepage v1</a></li>
                <li><a className="dropLink" href="#">Homepage v2</a></li>
                <li><a className="dropLink" href="#">Homepage v3</a></li>
              </ul> */}
            </div>
            <Nav.Link className="links" href="/Shop">shop</Nav.Link>
            <Nav.Link className="links" href="/product">Product</Nav.Link>
            {/* <Nav.Link className="links rsale" href="/Sale">Sale</Nav.Link> */}
            {/* <Nav.Link className="links" href="/Features">Features</Nav.Link> */}
